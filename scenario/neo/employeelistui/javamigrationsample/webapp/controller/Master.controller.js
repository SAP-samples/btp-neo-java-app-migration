sap.ui.define([
	...
	return Controller.extend("javamigrationsample.controller.Master", {
		onInit: function () {
			...
			models.createCurruentUserModel().then(function (oModel) {
		...
		onAddEmpoyeePress: function (oEvent) {
			this.pDialog = this.loadFragment({
				name: "javamigrationsample.fragments.AddEmloyee"
			});
		...
		formatAvatar: function (imageId) {
			var sUrl = "";
			if (imageId) {
				sUrl = "/java/images?documentId=" + imageId;
			} else {
